      <div class="row">
        ...
        <form method="POST" action="">
            ...
            <label for="titre">IT</label>
            <br>
    <input type="checkbox" name="choix[]" value="devweb"> Web developpement <br>
    <input type="checkbox" name="choix[]" value="devapp"> App developpement<br>
    <input type="checkbox" name="choix[]" value="devge"> General developpement<br>
    <input type="checkbox" name="choix[]" value="net"> Network<br>
    <input type="checkbox" name="choix[]" value="unix"> Unix<br>
    <input type="checkbox" name="choix[]" value="osx"> OSX<br>
    <input type="checkbox" name="choix[]" value="windows"> Windows<br>
    <input type="checkbox" name="choix[]" value="security"> Security<br></div>
    ...
    <div class="form-group">
    <label for="titre">Sport</label><br>
    <input type="checkbox" name="choix[]" value="foot"> Football <br>
    <input type="checkbox" name="choix[]" value="rugby"> Rugby <br>
    <input type="checkbox" name="choix[]" value="basket"> Basketball<br>
